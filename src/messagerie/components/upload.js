        ...
        <div className="bg-gray-200 font-sans">
            <div className="flex flex-col sm:flex-row sm:justify-around">
                <div className="w-full h-screen bg-blue-200">
                    ...
                    <button className="w-full flex justify-between items-center py-3 px-6 text-green-900 cursor-pointer bg-gradient-to-b from-blue-400 to-blue-300 hover:bg-gray-300 hover:text-white focus:outline-none rounded">
                    ...
                    <div className="mt-4">
                        ...
                        <button className="w-full flex justify-between items-center py-3 px-6 text-gray-600 cursor-pointer bg-gradient-to-b from-blue-400 to-blue-300 hover:bg-gray-300 hover:text-white focus:outline-none rounded">
                            <span className="flex items-center">
